...
function AboutPage() {
    return (
        ...
        <div className='container'>
            ...
            <HorizontalBubbles count={1} delay />
            <HorizontalBubbles count={1} />

            <StyledAboutContainer className='container'>
                {/* <div className='card'> */}
                <p>
                    With <span className='underline'>4+ years</span> of professional developer experience, I have had
                    the opportunity to work with top healthcare professionals such as{" "}
                    <span className='underline'>Novartis</span> and <span className='underline'>Johnson & Johnson</span>
                    , along with a handful of upcoming musicians.
                </p>
            ...
            <StyledAboutContainer className='container'>
                <p className='mt-1'>
                    With any spare time I try to get outside and go hiking, where I can enjoy endless native flora &
                    fauna. Since 2019 I have been nurting a native plant garden at my local library, hoping to spread
                    the knowledge of native plants. As for hiking, I have traveled from
                    <span className='d-block bungee' style={{ display: "flex", justifyContent: "space-between" }}>
                        <span>coast</span>
                        <span>to</span>
                        <span>coast</span>
                    </span>
            ...
            <HorizontalBubbles count={1} />
            <HorizontalBubbles count={1} delay marginClass='2 mb-1' />
